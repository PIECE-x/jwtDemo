...
public class JwtDemoApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(JwtDemoApp.class);

    private final Environment env;

    public JwtDemoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JwtDemoApp.class);
